...
//    [alert show];
    ...
    UIAlertController *alertVc = [UIAlertController alertControllerWithTitle:[self.updateTitle stringByAppendingString:newVersion] message:message preferredStyle:UIAlertControllerStyleAlert];
