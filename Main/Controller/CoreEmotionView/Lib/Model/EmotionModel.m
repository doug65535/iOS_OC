...
static NSArray *_emotions_recent,*_emotions_recent_subArray,*_emotions_default,*_emotions_default_subArray,*_emotions_emoji,*_emotions_emoji_subArray;
...
+(NSArray *)arrayWithFolderName:(NSString *)folderName{
    ...
    //获取路径
    NSString *path = [[NSBundle mainBundle] pathForResource:[NSString stringWithFormat:@"%@/%@/emotion",EmotionBundelName,folderName] ofType:@"plist"];
...
//    NSArray *oldEmotions =_emotions_default;
    ...
    NSArray *oldEmotions = _emotionsFromArc;
