...
@interface SMMapFover ()
@property (nonatomic,strong)NSMutableArray *modelArr;
@end

@implementation SMMapFover
...
-(void)loadMoreModel
    {
        ...
        NSString *strUrl = [NSString stringWithFormat:@"http://www.dituhui.com/api/v2/users/%@/favorites.json",account.user_id];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if (self.modelArr.count == 0) {
        ...
        vHeader.textLabel.text = @"还没有收藏地图";
    }else
    {
        vHeader = nil;
    }
