...
@interface SMPofileFoverVc ()<SMTableViewCellDelegate,UMSocialUIDelegate>
/**
 *  内容数组(里面存储的是所有内容的模型)
 */
...
@implementation SMPofileFoverVc
...
-(void)loadBlogStatus
{
    ...
    // 发送请求
    NSString *urlString = @"http://club.dituhui.com/api/v2/favorites/messages";
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if (self.statuses.count == 0) {
        ...
        vHeader.textLabel.text = @"还没有收藏过的帖子";
    }else
    {
        vHeader = nil;
    }
